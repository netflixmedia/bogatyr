...
//	private static final String TAG_BUILDS           = "builds"; //$NON-NLS-1$
//	private static final String TAG_CURRENT          = "current"; //$NON-NLS-1$
...
//	private int minorversion_current;
	private int minorversion_min;
	private int minorversion_max;
//	private int build_current;
...
//	private boolean isBuildCurrent;
    ...
    private void download() throws IOException {
		File output = new File(HelperEnvInfo.getUserHomeDirectory() + "/" + (HelperEnvInfo.isWindowsPlatform() ? name_windows : name_osx));
		boolean isOk = false;
		...
		final String location = (HelperEnvInfo.isWindowsPlatform() ? location_windows : location_osx);
...
//    	} else if (TAG_BUILDS.equals(qualifiedName)) {
//    		isBuilds = true;
//    	} else if (TAG_CURRENT.equals(qualifiedName)) {
//    		if (isVersions) {
//    			isVersionCurrent = true;
//    		} else if (isMinorVersions) {
//    			isMinorVersionCurrent = true;
//    		} else {
//    			isBuildCurrent = true;
//    		}
	...
	public void endElement(String namespaceUri, String localName, String qualifiedName) throws SAXException {
		if (TAG_APPLICATION.equals(qualifiedName)) {
			if (name.equals(Context.getInstance().getApplicationName())) {
...
//			isBuilds = false;
	...
	public void characters(char[] chars, int startIndex, int endIndex) {
    	...
    	if (isName) {
    		name = value;
    		isName = false;
//    	} else if (isVersionCurrent) {
//    		version_current = HelperGeneral.isStringNumeric(value) ? Integer.parseInt(value) : Integer.MAX_VALUE;
//    		isVersionCurrent = false;
    		...
    		isVersionMax = false;
//    	} else if (isMinorVersionCurrent) {
//    		minorversion_current = HelperGeneral.isStringNumeric(value) ? Integer.parseInt(value) : Integer.MAX_VALUE;
//    		isMinorVersionCurrent = false;
...
//    	} else if (isBuildCurrent) {
//    		build_current = HelperGeneral.isStringNumeric(value) ? Integer.parseInt(value) : Integer.MAX_VALUE;
