...
public abstract class Constants {
	//Bogatyr specific
	public static final Document BOGATYR = new DocumentImpl("Bogatyr", new BigDecimal("0.91"), 238, HelperTime.getDate(17, 2, 2010), null, null, null, UUID.fromString("4d8f7b88-2a1e-4f74-98ca-99d8a0cf97a5")); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
