...
import ch.orwell.bogatyr.helper.HelperEnvInfoTest;
import ch.orwell.bogatyr.helper.HelperFileTest;
import ch.orwell.bogatyr.helper.HelperGeneralTest;
import ch.orwell.bogatyr.helper.HelperGraphicTest;
import ch.orwell.bogatyr.helper.HelperImageTest;
import ch.orwell.bogatyr.helper.HelperMathTest;
import ch.orwell.bogatyr.helper.HelperNetTest;
import ch.orwell.bogatyr.helper.HelperPdfTest;
import ch.orwell.bogatyr.helper.HelperPreferencesTest;
import ch.orwell.bogatyr.helper.HelperSoundTest;
import ch.orwell.bogatyr.helper.HelperXmlTest;
import ch.orwell.bogatyr.helper.PaginatorTest;
import ch.orwell.bogatyr.helper.PrinterTest;
import ch.orwell.bogatyr.helper.context.ContextTest;
import ch.orwell.bogatyr.helper.converter.ConverterBase64Test;
import ch.orwell.bogatyr.helper.crypto.CryptoAsymmTest;
import ch.orwell.bogatyr.helper.crypto.CryptoSymmTest;
import ch.orwell.bogatyr.helper.crypto.ObfuscatorTest;
import ch.orwell.bogatyr.helper.localizer.LocalizerTest;
...
//		testSuite.addTestSuite(PrinterTest.class);
	...
	public void run() {
		try {
			(new TestRunner()).start(new String[]{"ch.orwell.bogatyr.AllBogatyrTests"}); //$NON-NLS-1$
		} catch (Exception ex) {
			ex.printStackTrace();
		}
	}
